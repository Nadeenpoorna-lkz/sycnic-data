...
async function free() {
  const _0x358828 = await fetchJson("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/master.json");
  const _0x127e0f = _0x358828.moviefree;
  return _0x127e0f;
}
async function getPremiumUsers() {
  const _0xd3b269 = await fetchJson("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/premirum.json");
...
cmd(_0x54be6c, async (_0x44dcde, _0x4da396, _0x73e2c7, {
  ...
  try {
    ...
    const _0x4e2d94 = (await axios.get("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/detailes.json")).data;
    ...
    const _0x559474 = {
      document: _0x11b50d,
      caption: "\n*" + _0x4ee1c7 + "*\n\n> *" + _0x62b49b + "*\n\n*⏤͟͟͞͞★❮𝗡 𝗔 𝗗 𝗘 𝗘 𝗡 〽️ 𝗢 𝗩 𝗜 𝗘❯⏤͟͟͞͞★*",
      mimetype: "video/mp4",
      fileName: "🎬NADEEN-MD🎬" + _0x4ee1c7 + ".mp4",
...
cmd(_0x12c2f1, async (_0x13c1a6, _0x41ab87, _0x4e0e5d, {
  ...
  try {
    ...
    const _0x2bf27f = (await axios.get("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/detailes.json")).data;
    ...
    const _0x3cda00 = {
      text: "*★❮𝗡 𝗔 𝗗 𝗘 𝗘 𝗡  𝗖 𝗜 𝗡 𝗘 𝗠 𝗔 ㋡❯★*\n\n👽 Entered Name || " + _0x23f31f,
      footer: _0x51c45a || "*⏤͟͟͞͞★❮𝗡 𝗔 𝗗 𝗘 𝗘 𝗡 〽️ 𝗢 𝗩 𝗜 𝗘❯⏤͟͟͞͞★*",
      title: "",
      buttonText: "🔢 Reply below number\n",
      sections: _0xb0fb31
    };
...
cmd(_0x24050f, async (_0x5c0893, _0x735076, _0x5b36cf, {
  ...
  try {
    ...
    const _0x5e346d = (await axios.get("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/detailes.json")).data;
    ...
    const _0x4696e9 = {
      ...
      footer: _0x419f7a || "*⏤͟͟͞͞★❮𝗡 𝗔 𝗗 𝗘 𝗘 𝗡 〽️ 𝗢 𝗩 𝗜 𝗘❯⏤͟͟͞͞★*",
      title: "",
      buttonText: "🔢 Reply below number\n",
      sections: _0xe912cc
    };
...
cmd(_0xaad77a, async (_0xff6abe, _0x482dbc, _0x2465e4, {
  ...
  try {
    ...
    let _0x52426b = "*★❮𝗡 𝗔 𝗗 𝗘 𝗘 𝗡  𝗖 𝗜 𝗡 𝗘 𝗠 𝗔 ㋡❯★*\n\n☘️ *Tɪᴛʟᴇ :* " + (_0x234dbe?.["title"] ?? "Null") + "\n\n*➟➟➟➟➟➟➟➟➟➟➟➟➟➟*\n▫️🔗 *Jᴏɪɴ :* https://whatsapp.com/channel/0029VagN2qW3gvWUBhsjcn3I\n*➟➟➟➟➟➟➟➟➟➟➟➟➟➟*";
...
cmd(_0x7c7ad3, async (_0x56e717, _0x46c030, _0x34c5ef, {
  ...
  try {
    ...
    const _0x393273 = (await axios.get("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/detailes.json")).data;
    ...
    const _0x2f9266 = {
      ...
      footer: _0x5b8b63 || "*⏤͟͟͞͞★❮𝗡 𝗔 𝗗 𝗘 𝗘 𝗡 〽️ 𝗢 𝗩 𝗜 𝗘❯⏤͟͟͞͞★*",
      title: "",
      buttonText: "🔢 Reply below number\n",
      sections: _0x329429
    };
...
cmd(_0x2e384c, async (_0x5e93fc, _0x1fcd3c, _0x4e2eb5, {
  ...
  try {
    ...
    const _0x2e159d = {
      ...
      fileName: "🎬NADEEN-MD🎬 " + _0x30b733.title + ".zip"
    };
    const _0x225bbc = {
      quoted: _0x1fcd3c
    };
...
cmd(_0x22f787, async (_0x15180e, _0x160f62, _0x1b7add, {
  ...
  try {
    const _0x820424 = (await fetchJson("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/Mreply.json")).replyMsg;
...
cmd(_0x556e94, async (_0x5ca077, _0x4e73f, _0x5ee1ab, {
  ...
  try {
    const _0x206283 = (await fetchJson("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/Mreply.json")).replyMsg;
...
cmd(_0x4701d0, async (_0x3649ce, _0x49be4e, _0x4c6bb3, {
  ...
  try {
    const _0x2f339b = (await fetchJson("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/Mreply.json")).replyMsg;
...
cmd(_0x386e39, async (_0x2c9f8a, _0x6b4f90, _0x417c76, {
  ...
  try {
    const _0x25d7b1 = (await fetchJson("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/Mreply.json")).replyMsg;
