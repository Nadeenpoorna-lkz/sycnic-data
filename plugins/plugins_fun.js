...
async function getPremiumUsers() {
  const _0x1809af = await fetchJson("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/premirum.json");
...
cmd(_0x1e0190, async (_0x6cc3e7, _0x29fb76, _0x362878, {
  ...
  try {
    const _0x4e2b94 = (await fetchJson("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/Mreply.json")).replyMsg;
...
cmd(_0xcb26b5, async (_0x52cf86, _0x3c0f36, _0x146706, {
  ...
  try {
    ...
    const _0x1677da = _0x4d8968.split("|")[1] || "NADEEN MD";
    const _0x4e6be9 = {
...
cmd(_0x4b7405, async (_0x587049, _0x3f90a9, _0xb5896b, {
  ...
  try {
    ...
    const _0x3aca63 = [{
      "title": "*[Result from Nadeen.lk]*\n",
      "rows": _0x1ec27a
    }];
    const _0x43e7bb = {
      text: "*NADEEN MD FANCY*",
      footer: "*✮ ק๏ฬєг๔ ๒ץ ŋค๔єєภ ק๏๏гภค*",
      buttonText: "*🔢 Reply below number*\n",
      sections: _0x3aca63
    };
