...
let baseUrl;
(async () => {
  let _0x5d412e = await fetchJson("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/premirum.json");
  baseUrl = _0x5d412e.api;
})();
async function getPremiumUsers() {
  const _0x3bdf94 = await fetchJson("https://raw.githubusercontent.com/Nadeenpoorna-lkz/sycnic-data/main/footer/premirum.json");
...
cmd(_0x41a371, async (_0x3ee616, _0x11aecd, _0x390d87, {
  ...
  try {
    ...
    _0x390d87.react("⬆️");
    const _0x180904 = await getimage("https://files.catbox.moe/zhdb46.png ");
    const _0x3ab1a5 = {
...
cmd(_0x17e6f9, async (_0x3c788a, _0x124931, _0x52931e, {
  ...
  try {
    ...
    _0x52931e.react("⬆️");
    const _0x1e2b6f = await getimage("https://files.catbox.moe/zhdb46.png ");
    const _0x45c550 = {
...
cmd(_0x3bc3a7, async (_0x2db28a, _0x2cafe7, _0x126f2d, {
  ...
  try {
    ...
    _0x126f2d.react("⬆️");
    const _0x547d3b = await getimage("https://files.catbox.moe/zhdb46.png ");
...
cmd(_0x2c7e28, async (_0x349560, _0x3b4de0, _0x4976da, {
  ...
  try {
    ...
    const _0x36eaae = await getimage("https://files.catbox.moe/zhdb46.png ");
...
cmd(_0x1ba9c2, async (_0x2480a9, _0x2b3958, _0x1de328, {
  ...
  try {
    ...
    const _0x14a0d1 = await getimage("https://files.catbox.moe/zhdb46.png ");
    const _0x157eae = {
      document: _0x1844ac,
...
cmd(_0x17449a, async (_0xc30223, _0x32908c, _0x1ae563, {
  ...
  try {
    ...
    const _0x315688 = await getimage(_0x1df2dc || "https://files.catbox.moe/zhdb46.png ");
    if (!_0x1c71d3) {
    ...
    const _0x498f1e = {
      ...
      fileName: "🎬NADEEN-MD🎬" + _0xb95dad + ".mp4"
    };
    const _0xf00b66 = {
      quoted: _0x32908c
    };
...
cmd(_0x295d36, async (_0x50792f, _0x574971, _0x57b44a, {
  ...
  if (_0x574971.quoted?.["documentMessage"]) {
    ...
    _0x574971.quoted.documentMessage.fileName = "🎬 NADEEN-MD 🎬 " + _0x2cd664 + "." + _0xb5792b;
  } else {
    if (_0x574971.quoted?.["documentMessage"]) {
      ...
      _0x574971.quoted.documentMessage.fileName = "🎬 NADEEN-MD 🎬 " + _0x2cd664 + "." + _0x1c7f8a;
    }
  }
